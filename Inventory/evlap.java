...
import java.sql.*;
public class evlap extends JFrame implements ActionListener
{
Container c;
JTable table1;
JButton b1;
JScrollPane jsp1;
String head1[]={"Purchase_ID", "Supplier_ID", "Configure_ID","Company_Name","Processor","Memory","Display_Size","Hard_Disk_Drive","Graphics_Memory","Ports_and_others","Connectivity","Keyboard","AC_power_adapter","Battery_type","OS","Quantity", "Price"};
