...
import java.sql.*;
public class owlog extends JFrame implements ActionListener
{
JLabel l1,l2;
JTextField t1;
JPasswordField pf;
...
pf.setBounds(150,90,100,25);
//b1.setBounds(200,140,75,35);
...
String a=t1.getText();
String b=pf.getText();
if((a.equals("owner")&&b.equals("peripherals"))||(a.equals("stock")&&b.equals("peri")))
{
...
ResultSet rs=st.executeQuery("Select * from ownerlogin");
while(rs.next())
{
