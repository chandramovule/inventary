...
import java.sql.*;
public class str extends JFrame implements ActionListener
{
...
new vlap().setVisible(true);
}
if(ae.getSource()==b8)
{
this.setVisible(false);
new plap().setVisible(true);
}
if(ae.getSource()==b1)
{
this.setVisible(false);
new vsy().setVisible(true);
}
if(ae.getSource()==b2)
{
this.setVisible(false);
new psy().setVisible(true);
}
if(ae.getSource()==b5)
{
this.setVisible(false);
new vah().setVisible(true);
}
if(ae.getSource()==b6)
{
this.setVisible(false);
