...
import java.sql.*;
public class eplap extends JFrame implements ActionListener, ItemListener
{
JTable table1;
JLabel l1;
JComboBox j;
...
{
setSize(700, 700);
setTitle("View particular laptop");
setVisible(true);
...
Connection c1=DriverManager.getConnection("jdbc:odbc:sss", "root", "");
Statement st=c1.createStatement();
ResultSet rs=st.executeQuery("select * from lap where Configure_ID='"+s+"'");
while(rs.next())
{
